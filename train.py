...
def parse_args():
    ...
    parser.add_argument('--light', type=bool, default=True, help='[U-GAT-IT full version / U-GAT-IT light version]')
    ...
    args.result_dir = './experiment/{}-size{}-ch{}-{}-lr{}-adv{}-cyc{}-identity{}-cam{}'.format(
